...
// mobile variant: 430px frames from dump-m-*.json (Romanian row on top, English below)
// usage: node generate-fig-m.js <out.fig>
const fs = require('fs');
...
const outFig = process.argv[2] || 'litro-mobile-web.fig';
...
nodeChanges.push({
  guid: { sessionID: 0, localID: 1 }, phase: 'CREATED', type: 'CANVAS', name: 'LITRO Mobile Web',
...
const pages = [
  // rând 1 — română
  { file: 'dump-m-home.json', name: 'Home / Mobile', ox: 0, oy: 0 },
  { file: 'dump-m-listing.json', name: 'Listing / Mobile', ox: 630, oy: 0 },
  { file: 'dump-m-hotel.json', name: 'Hotel Details / Mobile', ox: 1260, oy: 0 },
  { file: 'dump-m-checkout.json', name: 'Checkout / Mobile', ox: 1890, oy: 0 },
  { file: 'dump-m-thankyou.json', name: 'Thank you / Mobile', ox: 2520, oy: 0 },
  // rând 2 — engleză
  { file: 'dump-m-home-en.json', name: 'Home (English) / Mobile', ox: 0, oy: 5200 },
  { file: 'dump-m-listing-en.json', name: 'Listing (English) / Mobile', ox: 630, oy: 5200 },
  { file: 'dump-m-hotel-en.json', name: 'Hotel Details (English) / Mobile', ox: 1260, oy: 5200 },
  { file: 'dump-m-checkout-en.json', name: 'Checkout (English) / Mobile', ox: 1890, oy: 5200 },
  { file: 'dump-m-thankyou-en.json', name: 'Thank you (English) / Mobile', ox: 2520, oy: 5200 },
];
...
const meta = {
  ...
  file_name: 'LITRO Mobile Web (RO + EN)',
...
try {
  execSync(`sips -Z 400 "/Users/mkoslacz/Workspaces/claude/litoralul_nop_designs/desktop-redesign/preview-m-home.png" --out "${stage}/thumbnail.png" >/dev/null 2>&1`);
